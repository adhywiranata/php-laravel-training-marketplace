  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="row experience-grid">
      <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 image-holder">
        <img src="{{ url('images/users/thumb/'.$testimonial->profile_picture) }}" width="70%"/>
        <!--<img src="{{ url('images/users/boto_simatupang.jpeg') }}" width="70%"/>-->
      </div>
      <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
        <a href="" class="title"><i class="bigger-1" style="font-size:1em">"{{$testimonial->testimony}}"</i></a>
        <!--<a href="" class="title"><i class="bigger-1" style="font-size:1em">"Great Trainer, Nice Delivery"</i></a>-->
        <p>{{$testimonial->first_name}} {{$testimonial->last_name}}

          @if($testimonial->job_title != "")
            , {{$testimonial->job_title}}
          @endif

          @if($testimonial->corporate_name != "")
            at {{$testimonial->corporate_name}}</p>
          @endif
        <!--<p>Raharjo Budi</p>-->
        <!--
