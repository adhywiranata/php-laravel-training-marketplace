...
function validateForm(validationRules,inputVal,input)
{
  ...
  if(validationRules.indexOf('required') > -1)
  {
    ...
    {
      input.parent().find('.form-error-message').html('');
    }
    else
    {
      input.parent().find('.form-error-message').html('Must be filled');
      errorFlag++;
    }
  }
  ...
  if(validationRules.indexOf('numeric') > -1)
  {
    ...
    {
      input.parent().find('.form-error-message').html('Must be numeric');
      errorFlag++;
    }
  }
  ...
  if(validationRules.indexOf('alpha') > -1)
  {
    ...
    {
      input.parent().find('.form-error-message').html('Must be Alphabetic');
      errorFlag++;
    }
  }
  ...
  if(validationRules.indexOf('email') > -1)
  {
    ...
    {
      input.parent().find('.form-error-message').html('Must be Email');
      errorFlag++;
    }
  }
...
$('.fg-form  > .fg-input').each(function(index,value){
  ...
  template += '<span class="text-red form-error-message"></span>';
  template += '</div>';
  template += '';

  if(typeof multiple !== 'undefined' && multiple != '')
  {
    template += '<a class="fg-more-field">+ Add New ' + label + '</a>';
  }
  ...
  {
    $(this).find('.form-label').append('<span class="text-red"> *</span>');
  }
